...
if __name__ == '__main__':
    ...
    similarity = model.predict([question_feature, relation_feature, relation_all_feature])

    np.save('test_gold.npy', similarity)
    ...
    similarity = model.predict([question_feature, relation_feature_neg, relation_all_feature_neg])

    np.save('test_neg.npy', similarity)
