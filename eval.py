...
def model_construct():
    # CONFIG
    config = ConfigParser()
    config.read('/home/stevenwd/HR-LSTM/config.ini')
    ...
    question_emd = np.load('/home/stevenwd/HR-LSTM/question_emd_matrix.npy')
    relation_emd = np.load('/home/stevenwd/HR-LSTM/relation_emd_matrix.npy')
    relation_all_emd = np.load('/home/stevenwd/HR-LSTM/relation_all_emd_matrix.npy')
...
if __name__ == '__main__':
    ...
    simi_pos = model.predict([question_feature, relation_feature, relation_all_feature])
    ...
    simi_neg = model.predict([question_feature, relation_feature_neg, relation_all_feature_neg])

    np.save('test_pre_pos.npy', simi_neg)
